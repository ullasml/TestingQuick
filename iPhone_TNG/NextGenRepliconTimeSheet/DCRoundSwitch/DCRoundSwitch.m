...
- (void)sizeToFit
{
    ...
    CGSize onstringSize = [onString sizeWithAttributes:
                         @{NSFontAttributeName:
                               self.toggleLayer.labelFont}];
    
    CGSize offstringSize = [offString sizeWithAttributes:
                           @{NSFontAttributeName:
                                 self.toggleLayer.labelFont}];
    
	CGFloat width = onstringSize.width;
   
	CGFloat offWidth = offstringSize.width;
