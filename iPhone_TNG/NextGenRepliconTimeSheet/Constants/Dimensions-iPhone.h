...
//#define EntriesTotalLabelFrame              CGRectMake(13.0, 0.0,50.0 ,30.0)
#define EntriesTotalLabelFrame                CGRectMake(12.0, 6.0,SCREEN_WIDTH-112 ,30.0)//US4065//Juhi
#define ArrowWidth ([UIImage imageNamed:Disclosure_Box].size.width+10)
#define EntriesTotalHoursLabelFrame         CGRectMake(SCREEN_WIDTH - ArrowWidth - 80, 6.0,80 ,30.0)
//#define EntriesTotalHoursLabelFrame           CGRectMake(98.0, 6.0,208.0 ,30.0)
...
#define TimeEntryTimeLabelFrame               CGRectMake(10.0,6.0,250.0,30.0)//US4065//Juhi
...
#define ReasonLabelFrame					  CGRectMake(60, 15.0, SCREEN_WIDTH-120, 50.0)//US4275//Juhi
#define SheetLabelFrame                       CGRectMake(60, 5, SCREEN_WIDTH-120,20)//US4275//Juhi
...
#define UDF_Cell_Row_Height_44 44
