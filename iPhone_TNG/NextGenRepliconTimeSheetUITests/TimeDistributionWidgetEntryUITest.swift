...
class TimeDistributionWidgetEntryUITest: XCTestCase {
    ...
    func setUpTimeDistributionWidgetEntryUI() {
        ...
        let timeDistributionWidgetEntryDetailsUITest = TimeDistributionWidgetEntryDetailsUITest()
        timeDistributionWidgetEntryDetailsUITest.setUpTimeDistributionWidgetEntryDetailsUI()
    }
}
