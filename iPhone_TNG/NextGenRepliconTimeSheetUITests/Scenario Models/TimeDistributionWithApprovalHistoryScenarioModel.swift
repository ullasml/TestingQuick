...
class TimeDistributionWithApprovalHistoryScenarioModel {
    var company:String?
    ...
    var approvalSummaryBeforeApproval = [ApprovalInfo]()
    ...
    init(data:Data){
        ...
        self.approvalSummaryBeforeApproval.append(ApprovalInfo(status: "Waiting for Approval", comments: ""))
        self.approvalSummaryBeforeApproval.append(ApprovalInfo(status: "Approved", comments: ""))
