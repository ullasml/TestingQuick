...
class ApprovalDailyWidgetTimesheetEntryUITest: XCTestCase {
    ...
    func setUpApprovalDailyWidgetTimesheetEntryUI() {
        ...
        if tablesQuery.exists
        {
            ...
            let approvalDailyWidgetTimesheetEntryDetailsUITest = ApprovalDailyWidgetTimesheetEntryDetailsUITest()
            approvalDailyWidgetTimesheetEntryDetailsUITest.setUpApprovalDailyWidgetTimesheetEntryDetailsUI()
        }
    }
}
